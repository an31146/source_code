    ...
    public class BufferingExample : Form
    {
        ...
        private void DrawToBuffer(Graphics g)
        {
            ...
            if (++count > 5)
            {
                ...
                g.DrawString("Buffering Mode: " + bufferingModeStrings[bufferingMode], new Font("Tahoma", 8), Brushes.White, 10, 10);
                g.DrawString("Right-click to cycle buffering mode", new Font("Tahoma", 8), Brushes.White, 10, 22);
                g.DrawString("Left-click to toggle timed display refresh", new Font("Tahoma", 8), Brushes.White, 10, 34);
            }
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                switch (rnd.Next(0, 3))
                {
                    case 0: r1 = 255; g1 = 0; b1 = 0;
                        break;
                    case 1: r1 = 0; g1 = 255; b1 = 0;
                        break;
                    case 2: r1 = 0; g1 = 0; b1 = 255;
                        break;
                }
                //g.DrawEllipse(new Pen(Color.FromArgb(rnd.Next(0, 255), rnd.Next(0, 255), rnd.Next(0, 255))),
                g.DrawEllipse(new Pen(Color.FromArgb(r1, g1, b1)),
                //g.FillEllipse(new Pen(Color.FromArgb(r1, g1, b1)).Brush,
