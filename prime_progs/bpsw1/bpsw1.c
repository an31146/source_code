...
int _iBPSW(mpz_t mpzN, int iStrong);
...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        iPrimeBPSW=_iBPSW(mpzN, 0);  /* standard Lucas-Selfridge test */
        iPrimeSBPSW=_iBPSW(mpzN, 1);  /* strong Lucas-Selfridge test */
